package creditcard.Views.Dialogs;/*
...
public class AddAccountForm extends JDialog
{
    ...
    public AddAccountForm(CCard parent, IDataAccessView controller)
    {
        super(parent);
        parentframe=parent;
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) throws ParseException {
        ...
        data.put("ccnumber", JTextField_CCNR.getText());
        data.put("expdate", JTextField_ExpDate.getText());
        if (JRadioButton_Gold.isSelected()) {
            data.put("accountType", "Gold");
        } else if (JRadioButton_Silver.isSelected()) {
            data.put("accountType", "Silver");
        }
        else{
            data.put("accountType", "Bronze");
        }
