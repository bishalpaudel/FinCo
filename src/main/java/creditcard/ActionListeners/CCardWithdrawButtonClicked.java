...
import creditcard.Views.Dialogs.WithdrawForm;
 ...
 */
public class CCardWithdrawButtonClicked implements ActionListener, IDataAccessView {

    FinCo parentFrame;
    private String selectedAccount;
    private Integer selectedIndex;
    public CCardWithdrawButtonClicked(FinCo parentFrame) {
    ...
    public void setData(HashMap<String, String> data){
        ...
        if(account != null){
            ...
            model.setValueAt(balance, selectedIndex, 4);
        }
    }
