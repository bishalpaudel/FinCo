...
import creditcard.Views.Dialogs.DepositForm;
 ...
 */
public class CCardDepositButtonClicked implements ActionListener, IDataAccessView {

    FinCo parentFrame;
    private String selectedAccount;
    private Integer selectedIndex;
    public CCardDepositButtonClicked(FinCo parentFrame) {
